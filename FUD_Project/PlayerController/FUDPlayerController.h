...
#include "FUDPlayerController.generated.h"
 ...
 */
UCLASS()
class FUD_PROJECT_API AFUDPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	*/
	...
	FString GetInfoText(const TArray<class AFUDPlayerState*>& Players);
	FString GetTeamsInfoText(class AFUDGameState* FUDGameState);
private:


	UPROPERTY()
	class AFUDHUD* FUDHUD;
